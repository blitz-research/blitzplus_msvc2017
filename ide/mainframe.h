...
private:
	...
	map<CWnd*,Html_Help*> helps;

	string last_quick_help;

	Html_Help *getHelp();
	Html_Help *getHelp( int index );
	Html_Help *findHelp();
	...
	//htmlhelplistener
	void helpOpen( Html_Help *help,const string &file );
	void helpTitleChange( Html_Help *help,const string &title );
};
